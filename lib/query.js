...
Query.prototype.count = function(table, criteria) {
    ...
    this._query = utils.buildCountSelectStatement(criteria, table);
    if(criteria) this._build(criteria);
                  ...
                  switch(key) {
                      case 'and':
                          Object.keys(statement[key]).forEach(function(attribute) {
                              operators.and(attribute, statement[key][attribute], ' AND ');
                          });
                          return;

                      case 'like':
                          Object.keys(statement[key]).forEach(function(attribute) {
                              operators.like(attribute, key, statement, ' AND ');
                          });
                          return;
                      ...
                      default:        /*
                          ...
                          operators.and(key, statement[key], ' AND ');
                          return;
                  }
